...
namespace ElLucian
{
    ...
    internal static class Lucian
    {
        ...
        public static String ScriptVersion
        {
            get
            {
                return typeof(Lucian).Assembly.GetName().Version.ToString();
            }
        }
        ...
        public static void OnLoad(EventArgs args)
        {
            ...
            Notifications.AddNotification(String.Format("ElLucian by jQuery v{0}", ScriptVersion), 10000);
            ElLucianMenu.Initialize();
