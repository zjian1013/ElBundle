...
namespace ElVi
{
    public class ElViMenu
    {
        ...
        public static void Initialize()
        {
            ...
            cMenu.AddItem(new MenuItem("ElVi.Combo.Flash", "Flash Q").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            ...
            {
                rMenu.AddItem(new MenuItem("ElVi.Settings.R" + enemy.BaseSkinName, string.Format("Ult: {0}", enemy.BaseSkinName)).SetValue(true));
            }

            _menu.AddSubMenu(rMenu);

            var itemMenu = new Menu("Items", "Items");
            itemMenu.AddItem(new MenuItem("ElVi.Items.Youmuu", "Use Youmuu's Ghostblade").SetValue(true));
            itemMenu.AddItem(new MenuItem("ElVi.Items.Cutlass", "Use Cutlass").SetValue(true));
            itemMenu.AddItem(new MenuItem("ElVi.Items.Blade", "Use Blade of the Ruined King").SetValue(true));
            itemMenu.AddItem(new MenuItem("ElVi.Harasssfsddass.E", ""));
            itemMenu.AddItem(new MenuItem("ElVi.Items.Blade.EnemyEHP", "Enemy HP Percentage").SetValue(new Slider(80, 100, 0)));
            itemMenu.AddItem(new MenuItem("ElVi.Items.Blade.EnemyMHP", "My HP Percentage").SetValue(new Slider(80, 100, 0)));
            ...
            clearMenu.AddItem(new MenuItem("ElVi.Clear.Player.Mana", "Minimum Mana for clear").SetValue(new Slider(55)));
            ...
            miscMenu.AddItem(new MenuItem("ElVi.misc.Notifications", "Use Notifications").SetValue(true));
